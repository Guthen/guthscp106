		...
		form = {
			...
			"Translations",
			{
				...
				},
				{
					...
					default = "Go To Sinkhole {sinkhole}",
				},
				{
					type = "String",
					name = "Menu: Place Sinkhole",
					id = "translation_menu_place_sinkhole",
					desc = "Text shown to SCP-106 from his menu to place a sinkhole. Available arguments: '{sinkhole}'",
					default = "Place Sinkhole {sinkhole}",
				},
				{
					type = "String",
					name = "Menu: Enter Pocket Dimension",
					id = "translation_menu_enter_dimension",
					desc = "Text shown to SCP-106 from his menu to enter his pocket dimension",
					default = "Enter Pocket Dimension",
				},
				{
					type = "String",
					name = "Menu: Place Sinkhole",
					id = "translation_menu_exit_dimension",
					desc = "Text shown to SCP-106 from his menu to exit his pocket dimension",
					default = "Exit Pocket Dimension",
				},
			},
			"Sounds",
			{
