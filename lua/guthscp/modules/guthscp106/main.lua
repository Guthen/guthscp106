	...
	config = {
		form = {
			...
			},
			{
				type = "Bool",
				name = "Should Change Speed",
				id = "should_sinkhole_change_speed",
				desc = "Should walking on a sinkhole change movement speed of non-SCP-106 players?",
				default = true,
			},
			{
				type = "Number",
				...
				desc = "If 'Should Change Speed' is enabled, how much should it scale players movement speed?",
				default = 0.8,
				min = 0.1,
				max = 1.0,
			},
			{
				...
				desc = "If 'Should Change Speed' is enabled, for how much time should players movement speed scale after ending walking on a sinkhole? Must be above 0.",
				default = 0.1,
				min = 0.1,
			},
			{
